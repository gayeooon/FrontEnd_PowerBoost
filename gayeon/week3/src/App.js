...
import resetImg from "../src/assets/ic-reset.svg";
import "./App.css";
      ...
      <div className="Box App-box">
        <div className="Box-inner">
          <div className="App-hands">
            <div
              className={`Hand ${
                gameHistory[gameHistory.length - 1] === "승리" ? "winner" : ""
              }`}
            >
            ...
            <div
              className={`Hand ${
                gameHistory[gameHistory.length - 1] === "패배" ? "winner" : ""
              }`}
            >
